...
#import "LXUtilsString.h"
#import <CommonCrypto/CommonDigest.h>
#import "NSString+URL.h"

@implementation LXUtilsString
/**
 *判断字符串是否为空
 */
...
+ (CGFloat)getLabelHeightWithFont:(CGFloat)textFont withText:(NSString *)text withMaxWidth:(CGFloat)maxWid with:(NSLineBreakMode)lineBrak maxNumberLine:(NSInteger)maxNumberLine
{
    ...
    CGSize size = [LXUtilsString getTextSizeWithStyle:dic withFont:[UIFont systemFontOfSize:textFont] wihtText:text withMaxWidth:maxWid withLineBrak:lineBrak];
    height = size.height;
